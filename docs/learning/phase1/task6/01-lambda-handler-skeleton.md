...
- 関連教材: [Task 3 / 01 - Lambda Proxy Integration](../task3/01-lambda-response-format-and-cors.md), [Task 3 / 03 - shared/response.py 設計](../task3/03-shared-response-helper-design.md), [Task 4 - shared/db.py](../task4/)
